...
var ittyRouter = require('itty-router');
...
*/
var handleCors = function handleCors(options) {
  if (options === void 0) {
    options = {};
  }
  ...
  return function (request) {
    var _options = options,
        _options$origin = _options.origin,
        origin = _options$origin === void 0 ? '*' : _options$origin,
        _options$methods = _options.methods,
        methods = _options$methods === void 0 ? 'GET, POST, PATCH, DELETE' : _options$methods,
        _options$headers = _options.headers,
        headers = _options$headers === void 0 ? 'referer, origin, content-type' : _options$headers,
        _options$maxAge = _options.maxAge,
        maxAge = _options$maxAge === void 0 ? null : _options$maxAge,
        _options$allowCredent = _options.allowCredentials,
        allowCredentials = _options$allowCredent === void 0 ? false : _options$allowCredent;
...
function toInterface(abi$1) {
  if (abi.Interface.isInterface(abi$1)) {
    return abi$1;
  }

  return new abi.Interface(abi$1);
}
/**
...
var Server = /*#__PURE__*/function () {
  ...
  _proto.add = function add(abi$1, handlers) {
    var abiInterface = toInterface(abi$1);

    for (var _iterator = _createForOfIteratorHelperLoose(handlers), _step; !(_step = _iterator()).done;) {
      var handler = _step.value;
      var fn = abiInterface.getFunction(handler.type);
      this.handlers[abi.Interface.getSighash(fn)] = {
        type: fn,
        func: handler.func
      };
    }
  ...
  _proto.handleRequest = /*#__PURE__*/function () {
    var _handleRequest = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(req) {
      var sender, callData, body, response;
      return runtime_1.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 10:
              if (!(!address.isAddress(sender) || !bytes.isBytesLike(callData))) {
                _context.next = 12;
                break;
              }

              return _context.abrupt("return", new Response('Invalid request format', {
                status: 400
              }));
            ...
            case 15:
              ...
              return _context.abrupt("return", new Response(JSON.stringify(response.body), {
            ...
            case 19:
              ...
              return _context.abrupt("return", new Response("Internal server error: " + _context.t0.toString(), {
                status: 500
              }));
  ...
  _proto.call = /*#__PURE__*/function () {
    var _call2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2(_call) {
      var calldata, selector, handler, args, result;
      return runtime_1.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              calldata = bytes.hexlify(_call.data);
              selector = calldata.slice(0, 10).toLowerCase(); // Find a function handler for this selector

              handler = this.handlers[selector];
            ...
            case 5:
              ...
              args = abi.defaultAbiCoder.decode(handler.type.inputs, '0x' + calldata.slice(10)); // Call the handler

              _context2.next = 8;
              return handler.func(args, _call);
            ...
            case 8:
              ...
              return _context2.abrupt("return", {
                status: 200,
                body: {
                  data: handler.type.outputs ? bytes.hexlify(abi.defaultAbiCoder.encode(handler.type.outputs, result)) : '0x'
                }
              });
...
//# sourceMappingURL=ccip-read-cf-worker.cjs.development.js.map
